...
@section('content')
    ...
    <div class="col-md-12 full-display">
        ...
        @if(!empty($data))
            ...
            {{-- FILE CONTENTS --}}
            <div class="col-md-6 full-display col-md-offset-3" id="raw-content">
                <h2 class="margin-top-3">Inserted file raw content:</h2>
                <p class="margin-top-3 text-left"> {{ $data }} </p>
            </div>

            {{-- DETAILS FROM FILE CONTENTS --}}
            <div class="col-md-6 col-md-offset-3 margin-top-3 margin-bottom-3" id="statistics">
            ...
            {{-- OTHER --}}
            <div class="col-md-6 full-display col-md-offset-3" id="other">
